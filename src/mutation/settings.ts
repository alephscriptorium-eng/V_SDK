...
export const ZIGURAT_LINEA_EDITOR_HOST_KEY = 'zigurat.lineaEditor.host';
export const ZIGURAT_LINEA_EDITOR_PORT_KEY = 'zigurat.lineaEditor.port';
 ...
 * 2) settings zigurat.lineaEditor.* (override / sin launcher)
