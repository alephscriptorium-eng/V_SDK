...
const DEFAULT_TASKS = [
    ...
    { label: "APB: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:5001"], detail: "Abrir" },
    ...
    { label: "NOV: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:8080"], detail: "Abrir" },
    ...
    { label: "TPE: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:3019"], detail: "Abrir" },
    ...
    { label: "OAE: Open [Swagger]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:3021"], detail: "Abrir" },
    { label: "OAE: Open [AsyncAPI]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:3022"], detail: "Abrir" },
    ...
    { label: "NRE: Open [Editor]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:1880"], detail: "Abrir" },
    { label: "NRE: Open [Dashboard]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:1880/ui"], detail: "Abrir" },
    ...
    { label: "BLE: Open [Editor]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:4200"], detail: "Abrir" },
    { label: "JKL: Start [Site]", type: "shell", command: "./scripts/serve-site.sh", isBackground: true, detail: "Puerto 4000" },
    { label: "JKL: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:4000/aleph-scriptorium/"], detail: "Abrir" },
    { label: "ZEU: Start [UI]", type: "shell", command: "npm", args: ["start"], isBackground: true, detail: "Puerto 3012" },
    { label: "ZEU: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:3012"], detail: "Abrir" },
    { label: "INS: Start [Inspector]", type: "shell", command: "npm", args: ["start"], isBackground: true, detail: "Puerto 6274" },
    { label: "INS: Open [Browser]", type: "shell", command: "cmd", args: ["/c", "start", "http://localhost:6274"], detail: "Abrir" },
